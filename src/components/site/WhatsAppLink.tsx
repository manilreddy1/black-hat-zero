...
export function WhatsAppLink({ url }: { url?: string | null }) {
  ...
  return (
    <a
      ...
      className="inline-flex items-center gap-2.5 rounded-md border border-[#25D366]/40 bg-[#25D366]/10 px-4 py-2.5 font-mono text-xs tracking-[0.15em] text-[#25D366] transition-colors hover:bg-[#25D366]/20"
    >
      <svg
        width="18"
        height="18"
